...
<div class="top-navbar bg-white border-bottom border-soft-secondary z-1035"
    style="color: #ffff07 !important; opacity:0px !important;background-color: black !important; font-size: 13px; line-height: 24px; font-weight: 600;">
    <div class="container">
        <div class="row">
                ...
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    @if (get_setting('show_language_switcher') == 'on')
                        <li class="list-inline-item dropdown mr-3" id="lang-change">
                            ...
                            @endphp
                            <a href="javascript:void(0)" class="dropdown-toggle text-reset py-2 mr-3 border-left-0 pr-3"
                                style="margin-top: 8px !important;" data-toggle="dropdown" data-display="static">
                    ...
                    @if (get_setting('show_currency_switcher') == 'on')
                        <hr class="hr">
                        <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0" style="margin-top: 8px !important;"
                            id="currency-change">
                            @php
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @auth
                        @if (isAdmin())
                            <li class="list-inline-item  border-left-0 pr-3 pl-0">
                                <a href="{{ route('admin.dashboard') }}"
                                    class="text-reset d-inline-block py-2">{{ translate('My Panel') }}</a>
                            </li>
                            <hr class="hr" style="margin-left:2px !important">
                        @else
                        ...
                        <li class="list-inline-item">
                            <a href="{{ route('logout') }}"
                                class="text-reset d-inline-block py-2">{{ translate('Logout') }}</a>
                        </li>
                    @else
                        <li class="list-inline-item border-left-0 pr-3 pl-0">
                            <a href="{{ route('user.login') }}"
                                class="text-reset d-inline-block py-2">{{ translate('Login') }}</a>
                        </li>
                        <hr class="hr" style="margin-left:2px !important">
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}"
                                class="text-reset d-inline-block py-2">{{ translate('Registration') }}</a>
                        </li>
                    @endauth
                </ul>
            </div>
                    ...
                    <div class="position-relative flex-grow-1">
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class=>
                                    <button class="btn btn-outline-secondary border-left-0 ico-background"
                                        style="" type="submit">
                    ...
                    @foreach (json_decode(get_setting('header_menu_labels'), true) as $key => $value)
                        <li class="list-inline-item border-right"
                            ...
                            <a href="{{ json_decode(get_setting('header_menu_links'), true)[$key] }}"
                                class="opacity-90 fs-14 px-3 py-2 d-inline-block fw-700 hov-opacity-100 text-reset">
                                <p id="nav-menu">
                                    @if ($value == 'Find A Mechanic')
                                        <span class="badge badge-pill badge-primary mechanic-pill-btn-blue">
